...
class RagService
{
    ...
    private function prompt(string $question, array $contexts): string
    {
        ...
        return <<<PROMPT
You are Health AI Platform, the AI assistant for a personal health logging platform.
Use the retrieved context when it is relevant.
Connect health logs, sleep, hydration, heart rate, symptoms, mood, and uploaded health documents.
