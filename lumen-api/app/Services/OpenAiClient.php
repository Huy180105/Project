...
class OpenAiClient
{
    ...
    {
        if (str_contains(strtolower($prompt), 'health log records')) {
            return 'Mock insight: sleep, hydration, and mood records are ready for trend analysis. Keep logging consistently, watch for repeated symptom patterns, and seek professional care for severe or persistent issues.';
        }

        return 'Mock RAG answer: configure OPENAI_API_KEY, PINECONE_HOST, and PINECONE_API_KEY to generate grounded answers from your health logs and uploaded documents.';
    }
