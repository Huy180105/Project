...
@section('title', 'Study Signals')

@section('content')
    <div class="grid gap-6 xl:grid-cols-[360px_1fr]">
        <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <h2 class="text-base font-semibold">New signal</h2>
        ...
        <section class="rounded-lg border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5 py-4">
                <h2 class="text-base font-semibold">Recent signals</h2>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                            <tr>
                                <td class="px-5 py-8 text-center text-slate-500" colspan="6">No study-life signals yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
